...
import { getPrevNextPages } from "../../lib/docs";
...
export default function DocumentationPage({
  ...
  return (
    <article className="mx-auto w-full max-w-4xl pb-16">
      ...
      {(prev || next) && (
        <div className="mt-10 flex items-center justify-between gap-4 border-t border-stone-200/80 pt-8 dark:border-stone-800">
          {prev ? (
            <Link
              to={prev.href}
              className="group flex flex-col items-start gap-1 rounded-2xl border border-stone-200/80 bg-white/75 px-5 py-4 shadow-sm transition-all hover:border-emerald-300 hover:shadow-emerald-100 dark:border-stone-800 dark:bg-stone-900/70 dark:hover:border-emerald-700 dark:hover:shadow-emerald-900/20"
            >
              <span className="text-xs font-semibold uppercase tracking-[0.16em] text-stone-400 dark:text-stone-500">
                Previous
              </span>
              <span className="flex items-center gap-2 text-sm font-medium text-stone-700 group-hover:text-emerald-600 dark:text-stone-300 dark:group-hover:text-emerald-400">
          ...
          {next ? (
            <Link
              to={next.href}
              className="group flex flex-col items-end gap-1 rounded-2xl border border-stone-200/80 bg-white/75 px-5 py-4 shadow-sm transition-all hover:border-emerald-300 hover:shadow-emerald-100 dark:border-stone-800 dark:bg-stone-900/70 dark:hover:border-emerald-700 dark:hover:shadow-emerald-900/20"
            >
              <span className="text-xs font-semibold uppercase tracking-[0.16em] text-stone-400 dark:text-stone-500">
                Next
              </span>
